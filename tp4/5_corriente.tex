...
\subsection{Gráficos de medición sobre el fusible}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Señal de tensión sobre el fusible, proporcional a la corriente entregada sin capacitor.}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Señal de tensión sobre el fusible, proporcional a la corriente entregada con C = 100 $\mu$F.}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Señal de tensión sobre el fusible, proporcional a la corriente entregada con C = 220 $\mu$F.}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Señal de tensión sobre el fusible, proporcional a la corriente entregada con C = 2200 $\mu$F.}
